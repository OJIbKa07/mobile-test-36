...
public class LocalDriverOld implements WebDriverProvider {

    private static final LocalConfig localConfig = ConfigFactory.create(LocalConfig.class);
    private static final ConnectionConfig connectionConfig = ConfigFactory.create(ConnectionConfig.class);
